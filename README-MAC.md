...
npx bddgen && npx playwright test -g "Login"
npx bddgen && npx playwright test -g "Dashboard"
npx bddgen && npx playwright test -g "Forgot Password"
npx bddgen && npx playwright test -g "Nav Bar"
npx bddgen && npx playwright test -g "Sidebar Navigation"

# Run a specific widget test
npx bddgen && npx playwright test -g "Add widget - Alerts"

# Run a specific sidebar navigation test
npx bddgen && npx playwright test -g 'Navigate to "Users Admin"'

# Run a specific nav bar interaction test
npx bddgen && npx playwright test -g "Toggle sidebar"
...
This repo is synced via GitHub. To set up on a new Mac:
