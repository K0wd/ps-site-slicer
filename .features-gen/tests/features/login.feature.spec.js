...
test.describe('Login', () => {
  ...
  test('Login flow — UI branding and full authentication', { tag: ['@smoke'] }, async ({ Given, When, Then, And, page }) => { 
